...
const Login = () => {
  ...
  return (
    <div className="py-8">
      <Helmet>
        <title>Login - Django Electro Store</title>
        <meta
          name="description"
          content="Login to your Django Electro Store account"
        />
      </Helmet>
        ...
        <div className="bg-white p-8 rounded-lg border border-gray-200 shadow-sm relative">
            ...
            <GoogleLogin
              ...
              onError={() =>
                toast({
                  ...
                  description: "Could not login using Google.",
                })
              }
            />
          </div>
          ...
          {isLoading && (
            <div className="absolute inset-0 bg-white/80 z-10 flex items-center justify-center rounded-lg">
              <div className="animate-spin h-10 w-10 border-t-4 border-blue-600 border-solid rounded-full" />
            </div>
          )}
        </div>
      </motion.div>
