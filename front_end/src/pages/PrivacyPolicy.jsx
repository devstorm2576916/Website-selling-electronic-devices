...
const PrivacyPolicy = () => {
  return (
    <div className="py-8">
      <Helmet>
        <title>Privacy Policy - Django Electro Store</title>
        <meta
          name="description"
          content="Read the Privacy Policy for Django Electro Store."
        />
      </Helmet>
      ...
      >
        ...
        <div className="space-y-4 text-gray-700">
          <p>
            Your privacy is important to us. It is Django Electro Store's policy
          ...
          <p>
            We use the information we collect to process transactions, provide
            customer service, and improve our website and services. We do not
          ...
          <p>
            ...
            some of your desired services. You have the right to access, update,
