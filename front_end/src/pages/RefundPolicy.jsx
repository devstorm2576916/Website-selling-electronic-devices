...
const RefundPolicy = () => {
  return (
    <div className="py-8">
      <Helmet>
        <title>Refund Policy - Django Electro Store</title>
        <meta
          name="description"
          content="Read the Refund Policy for Django Electro Store."
        />
      </Helmet>
      ...
      >
        ...
        <div className="space-y-4 text-gray-700">
          <p>
            ...
            completely satisfied, you may be eligible for a return or exchange.
          </p>
